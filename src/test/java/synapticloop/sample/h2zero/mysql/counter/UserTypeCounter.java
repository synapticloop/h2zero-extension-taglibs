...
/**
 * <p>The UserTypeCounter contains all counters that are defined
 * in the h2zero file for the <code>user_type</code> table.  These counters
 ...
 *
 * <pre>UserTypeCounter.counterName(parameter1, parameter2, ...)
 *          .execute();
 * </pre>
 *
...
public class UserTypeCounter {
	...
	/**
	 * <p>Create a counter for the <code>UserType</code> database	 * table that will count all results.</p>
	 * 
