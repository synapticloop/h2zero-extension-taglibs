...
/**
 * <p>The UserTitleCounter contains all counters that are defined
 * in the h2zero file for the <code>user_title</code> table.  These counters
 ...
 *
 * <pre>UserTitleCounter.counterName(parameter1, parameter2, ...)
 *          .execute();
 * </pre>
 *
...
public class UserTitleCounter {
	...
	/**
	 * <p>Create a counter for the <code>UserTitle</code> database	 * table that will count all results.</p>
	 * 
