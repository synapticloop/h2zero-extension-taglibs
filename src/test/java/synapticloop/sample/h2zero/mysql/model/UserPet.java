...
public class UserPet extends ModelBase {
	...
	public static final int HIT_ID_USER_PET = 1; // The number of hits on the id_user_pet property
	...
	/**
	 * <p>Create a new <code>UserPet</code> object with all fields
	...
	/**
	 * <p>Convenience method for returning the primary key field (which is the id_user_pet field).</p>
	 * 
	...
	/**
	 * <p>Set the primary key field (which is the id_user_pet field).</p>
	 * 
	 ...
	 * 
	 * @param idUserPet The primary key field to update
	 */
