...
public class FindByTxtAddressEmailTag extends BaseVarTag {
	...
	public int doStartTag() throws JspException {
		if(limit != null) {
			pageContext.setAttribute(var, UserFinder.findByTxtAddressEmail(txtAddressEmail, ).withLimit(limit).withOffset(offset).executeSilent());
		} else {
			pageContext.setAttribute(var, UserFinder.findByTxtAddressEmail(txtAddressEmail).executeSilent());
		}
