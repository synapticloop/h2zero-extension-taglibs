 ...
 *
 * <pre>UserTitleQuestion.questionName(parameter1, parameter2, ...)
 *          .execute();
 * </pre>
 *
 ...
 */
public class UserTitleQuestion {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(UserTitleQuestion.class);


	// this is an internal SQL question select statement used by the validator
	private static final String SQL_INTERNAL_DOES_PRIMARY_KEY_EXIST = "SELECT (COUNT(*) = 1) WHERE id_user_title = ?";
	 ...
	 * 
	 * @param idUserTitle The primary key for this model.
	 * 
	 * @return whether the primary key exists
	 */
	public static boolean internalDoesPrimaryKeyExist(Long idUserTitle) {
