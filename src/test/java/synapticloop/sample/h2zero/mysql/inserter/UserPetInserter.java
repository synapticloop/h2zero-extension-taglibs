...
public class UserPetInserter {
	...
	/**
	 * <p>Insert a new <code>UserPet</code> into the database utilising the passed in connection.</p>
	 * 
	...
	/**
	 * <p>Insert a new UserPet into the database a new connection will be retrieved 
