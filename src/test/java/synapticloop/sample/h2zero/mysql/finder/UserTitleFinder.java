...
import synapticloop.sample.h2zero.mysql.finder.bean.UserTitleFindIdUserTitleNmUserTitleOrderedBean;
...
public class UserTitleFinder {
	...
	/**
	 * <p>Create a Finder that can find a unique row of the <code>com.synapticloop.h2zero.generator.model.Table@2e8fd343</code> table or view by its primary key.</p>
	 * 
	 ...
	 * 
	 * <ul>
	 *   <li>Return a <code>UserTitle</code> object, or</li>
