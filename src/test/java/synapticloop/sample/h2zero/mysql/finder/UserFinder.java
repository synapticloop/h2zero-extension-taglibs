...
import synapticloop.sample.h2zero.mysql.finder.bean.UserFindNmUserDtmSignupBean;
import synapticloop.sample.h2zero.mysql.finder.bean.UserFindGroupNumAgeBean;
...
public class UserFinder {
	...
	/**
	 * <p>Create a Finder that can find a unique row of the <code>com.synapticloop.h2zero.generator.model.Table@58f0d956</code> table or view by its primary key.</p>
	 * 
