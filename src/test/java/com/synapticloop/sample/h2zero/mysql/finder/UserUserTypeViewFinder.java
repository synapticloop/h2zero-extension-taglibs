...
public class UserUserTypeViewFinder {
	...
	/**
	 * <p>Create a Finder that can find a unique row of the <code>com.synapticloop.h2zero.generator.model.View@4f6e182c</code> table or view by its primary key.</p>
	 * 
