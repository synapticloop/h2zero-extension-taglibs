...
public class User extends ModelBase {
	...
	public JSONObject toJSON() {
		...
		ModelBaseHelper.addtoJSONObject(fieldsObject, "txtPassword", this.getTxtPassword());
	...
	public String toXMLString() {
		return("<user>" + 
			...
			String.format("<txt_password null=\"%b\">%s</txt_password>", (this.getTxtPassword() == null), (this.getTxtPassword() != null ? XmlHelper.escapeXml(this.getTxtPassword()) : "")) + 
