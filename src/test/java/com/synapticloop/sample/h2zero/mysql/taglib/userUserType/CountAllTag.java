...
import com.synapticloop.sample.h2zero.mysql.counter.UserUserTypeViewCounter;
...
public class CountAllTag extends BaseVarTag {
	...
	public int doStartTag() throws JspException {
		pageContext.setAttribute(var, UserUserTypeViewCounter.countAll().executeSilent());
