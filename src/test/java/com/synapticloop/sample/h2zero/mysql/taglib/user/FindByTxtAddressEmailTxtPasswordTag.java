...
public class FindByTxtAddressEmailTxtPasswordTag extends BaseVarTag {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(FindByTxtAddressEmailTxtPasswordTag.class);
	...
	public int doStartTag() throws JspException {
		if(limit != null) {
			pageContext.setAttribute(var, UserFinder.findByTxtAddressEmailTxtPasswordSilent(txtAddressEmail, txtPassword, limit, offset));
		} else {
