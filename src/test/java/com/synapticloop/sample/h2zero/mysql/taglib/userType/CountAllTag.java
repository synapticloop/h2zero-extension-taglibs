package com.synapticloop.sample.h2zero.mysql.taglib.userType;
...
import com.synapticloop.sample.h2zero.mysql.counter.UserTypeCounter;
...
public class CountAllTag extends BaseVarTag {
	...
	public int doStartTag() throws JspException {
		pageContext.setAttribute(var, UserTypeCounter.countAll().executeSilent());
