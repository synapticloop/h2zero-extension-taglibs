package com.synapticloop.sample.h2zero.mysql.taglib.pet;
...
import com.synapticloop.sample.h2zero.mysql.counter.PetCounter;
...
public class CountAllTag extends BaseVarTag {
	...
	public int doStartTag() throws JspException {
		pageContext.setAttribute(var, PetCounter.countAll().executeSilent());
