...
public class UserFinder {
	...
	/**
	 * <p>Create a Finder that can find a unique row of the <code>com.synapticloop.h2zero.generator.model.Table@2a98b4a1</code> table or view by its primary key.</p>
	 * 
